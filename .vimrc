...
"Temporarily block by TCP/IP class vim setting
"set noexpandtab

"42header information
let g:hdr42user = 'hyunwkim'
let g:hdr42mail = 'hyunwkim@student.42.fr'
...
" Mapping
inoremap jj <esc>
nnoremap r :RainbowParentheses<enter>
